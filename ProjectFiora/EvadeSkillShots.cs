...
namespace FioraProject
{
    ...
    class EvadeSkillShots
    {
        ...
        public static void Evading()
        {
            ...
            var skillshot =
                Evade.Evade.SkillshotAboutToHit(Player, 0 + Game.Ping + Program.Menu.SubMenu("Evade").SubMenu("Phép bổ trợ").SubMenu(parry.Name).Item("WDelay").GetValue<Slider>().Value)
                    .Where(
                        i =>
